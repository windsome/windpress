...
//import warning from 'react-router/modules/routerWarning'
...
function routerWarning(falseToWarn, message, ...args) {
...
const { bool, object, string, func, shape, oneOfType } = React.PropTypes
...
export const Link = React.createClass({
  ...
  render() {
    const { to, replace, query, hash, state, activeClassName, activeStyle, onlyActiveOnIndex, ...props } = this.props
    warning(
      !(query || hash || state),
